...
namespace MGM.Core
{
    ...
    public class SingleShotSystem : JobComponentSystem
    {
        ...
        protected override void OnCreate()
        {
            ...
            {
                All = new ComponentType[] { typeof(Shot), typeof(Magazine), ComponentType.ReadOnly <SingleShot>(), ComponentType.ReadOnly<LocalToWorld>()},
        ...
        struct SingleShotJob : IJobForEachWithEntity<Shot, Magazine,LocalToWorld, SingleShot>
        {
