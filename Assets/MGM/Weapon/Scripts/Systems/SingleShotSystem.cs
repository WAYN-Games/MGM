...
namespace MGM.Core
{
    ...
    public class SingleShotSystem : JobComponentSystem
    {
        ...
        protected override void OnCreate()
        {
            ...
            {
                All = new ComponentType[] { typeof(Shot), typeof(Magazine),typeof(SoundFX), typeof(ECS_VFX),ComponentType.ReadOnly<SingleShot>(), ComponentType.ReadOnly<LocalToWorld>()},
        ...
        struct SingleShotJob : IJobForEachWithEntity<Shot, Magazine, SoundFX, ECS_VFX,LocalToWorld, SingleShot>
        {
